...
$discountedPrice = $totalPrice; // Initialize discounted price
...
if ($promoApplied) {
    echo "<p>Promo applied! Discounted price: $discountedPrice</p>";
} else {
    echo "<p>No promo applied. Total price: $totalPrice</p>";
}

...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['receipt_content'])) {
    ...
    try {
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'mohamedinaaz1@gmail.com';  // Your Gmail address
        $mail->Password = 'kfjm hted juyf wybw';     // App password for Gmail (use app password for security)
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
        $mail->Port = 587;

        // Recipients
        $mail->setFrom('mohamedinaaz1@gmail.com', 'GOAL7 Futsal Booking'); // Your email address and name
